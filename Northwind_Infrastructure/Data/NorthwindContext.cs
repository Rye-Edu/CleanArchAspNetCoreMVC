...
namespace Northwind_Infrastructure.Data {
    public partial class NorthwindContext : DbContext
    {
        ...
        public virtual DbSet<StorePurchase> StorePurchases { get; set; }
...
//            => optionsBuilder.UseSqlServer("Server=.\\SQLEXPRESS; Database=Northwind; user=sa; password=ryeEdu24; Encrypt=false; Trusted_Connection=True;");
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<PurchaseRequest>(entity =>
            {
                ...
                entity.HasOne(d => d.User).WithMany(p => p.PurchaseRequests)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_PurchaseRequest_User");
            });
            ...
            modelBuilder.Entity<StorePurchase>(entity =>
            {
                ...
                entity.Property(e => e.UserApproverId).HasColumnName("User_ApproverID");

                entity.HasOne(d => d.PurchaseRequest).WithMany(p => p.StorePurchases)
                    .HasForeignKey(d => d.PurchaseRequestId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_StorePurchase_PurchaseRequest");

                entity.HasOne(d => d.UserApprover).WithMany(p => p.StorePurchases)
                    .HasForeignKey(d => d.UserApproverId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_StorePurchase_User");
            });
